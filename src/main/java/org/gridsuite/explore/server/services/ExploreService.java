...
public class ExploreService {
    ...
    public Mono<Void> createStudy(String studyName, UUID caseUuid, String description, String userId, UUID parentDirectoryUuid, HashMap<String, Object> importParams) {
